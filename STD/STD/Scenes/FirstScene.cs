        ...
        void test()
        {
            ...
            if (Enemies.Count < 2000)
            {
                ...
                //{
                    ...
                    IEnemy enemy4 = new Enemy3Blue(Rand.Float(Global.GAME.Width), Rand.Float(Global.GAME.Height));
                    Enemies.Add(enemy4);
                    Add(enemy4);

                    IEnemy enemy5 = new Enemy3Blue(Rand.Float(Global.GAME.Width), Rand.Float(Global.GAME.Height));
                    Enemies.Add(enemy5);
                    Add(enemy5);
